                ...
                <div id="primary" class="aux-primary" >
                    <div class="content" role="main"  >
                        <div class="home-hero-container">
                            ...
                            <img class="pearl-logo" src="<?php echo $imageArray["url"];?>/logo_transparent_background.png" alt="" class="alignnone size-medium wp-image-544" />
                        </div>
                        <section class='main-content'>
                            ...
                            <div class='pearl-question-container clearfix'>
                                ...
                                <p class='pearl-questions'>want to let go of the anger and the bitterness?</p>
                                <p class='pearl-questions'>want to find an anchor for your emotions?</p>
                                <p class='pearl-questions'>want to stop comparing yourself to others and just be YOU?</p>
                            ...
                            <div class='pearl-side-by-side-img-right'>
                                <div class='pearl-side-by-side-text-container'>
                                    <div class='pearl-side-by-side-text'>
                                        For more information on Pearl, email <a class='rox-email' href='mailto:roxanna@therelationshipwarehouse.com'>roxanna@therelationshipwarehouse.com</a> or <a class='rox-email' href='mailto:Jaclynnclark@gmail.com'>Jaclynnclark@gmail.com</a>
                                        <br />
